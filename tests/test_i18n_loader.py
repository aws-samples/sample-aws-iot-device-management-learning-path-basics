...
class TestI18nLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_script_messages = {
            "title": "Test Script",
            "separator": "================",
            "prompts": {"user_input": "Enter value: ", "confirmation": "Continue? [y/N]: "},
    ...
    def test_load_messages_nested_structure(self):
        ...
        nested_messages = {"prompts": {"user_input": "Enter value: ", "nested": {"deep": "Deep nested value"}}}
    ...
    def test_unicode_and_special_characters(self):
        ...
        unicode_messages = {
            "en": {"emoji": "✅ Success! 🎉", "symbols": "Progress: ▓▓▓░░ 60%", "currency": "Cost: $12.34"},
            "es": {"emoji": "✅ ¡Éxito! 🎉", "symbols": "Progreso: ▓▓▓░░ 60%", "currency": "Costo: €12,34"},
            "ja": {"emoji": "✅ 成功！🎉", "symbols": "進捗: ▓▓▓░░ 60%", "currency": "費用: ¥1234"},
            "zh-CN": {"emoji": "✅ 成功！🎉", "symbols": "进度: ▓▓▓░░ 60%", "currency": "费用: ¥12.34"},
        }
