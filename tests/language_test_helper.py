...
class LanguageTestHelper:
    ...
    def validate_language_completeness(self, language: str) -> Dict[str, any]:
        ...
        results["missing_scripts"] = [script for script in self.expected_scripts if script not in results["script_files"]]
...
def main():
    ...
    parser.add_argument("--compare", "-c", nargs=2, metavar=("LANG1", "LANG2"), help="Compare two languages")
